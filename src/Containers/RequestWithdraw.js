  ...
  return (
    <form onSubmit={handleSubmit}>
      <table className="table table-bordered table-invested">
        <tbody>
          <tr>
            <td colSpan={3} style={{ whiteSpace: 'normal' }}>For {tokenDisplayAmount} QUANTFUND, you will receive {ethValue} ETH. Click withdraw to confirm.</td>
          </tr>
          <tr>
            <td colSpan={3}>
          ...
          <tr>
            <td>
              <img alt="C20 Icon" className="ccc" src="/image/token.png" />
              {tokenDisplayAmount}
            </td>
            <td>
...
const EnhancedFormWithdraw = withFormik({
...
const EnhancedFormDeposit = withFormik({
  mapPropsToValues: ({ tokenAmount }) => {
    return ({
      tokenAmount: tokenAmount,
    })
...
const EnhancedFormWidraw = withFormik({
  mapPropsToValues: ({ tokenAmount }) => {
    return ({
      tokenAmount: tokenAmount,
    })
      ...
      case txState.NONE:
        return (
          <div className={"col-sm-12" + disabledClass}>
            ...
            <h6 style={{ marginTop: 0 }}>CHOOSE QUANTFUND DEPOSIT AMOUNT:</h6>
            <div className="table-responsive">
              <EnhancedFormDeposit tokenAmount={0} {...formProps} withdrawFunc={withdrawFunc} />
            </div>
            <h6 style={{ marginTop: 0 }}>CHOOSE QUANTFUND REQUEST AMOUNT:</h6>
            <div className="table-responsive">
              <EnhancedFormWidraw tokenAmount={0} {...formProps} withdrawFunc={withdrawFunc} />
            </div>
            <h6 style={{ marginTop: 0 }}>CHOOSE QUANTFUND WITHDRAWAL AMOUNT:</h6>
            <div className="table-responsive">
              <EnhancedFormWithdraw tokenAmount={0} {...formProps} withdrawFunc={withdrawFunc} />
            </div>
          </div>
        )
      case txState.INIT:
